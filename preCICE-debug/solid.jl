...
dimensions = 2 #PreCICE.getDataDimensions()
...
# set mesh vertex
vertexIDs_n = PreCICE.setMeshVertices("Nurbs-Mesh-Solid", vertices_n)
vertexIDs_f = PreCICE.setMeshVertices("Force-Mesh-Solid", vertices_f)
...
let # setting local scope for dt outside of the while loop
    ...
    if PreCICE.requiresInitialData()
        PreCICE.writeData("Nurbs-Mesh-Solid", "Displacements", vertexIDs_n, writeData)
    end
    ...
    while PreCICE.isCouplingOngoing()
        ...
        readData = PreCICE.readData("Force-Mesh-Solid", "Forces", vertexIDs_f, dt)
