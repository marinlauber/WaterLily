...
begin
	function get_force(sim,t)
		...
		return -WaterLily.pressure_force(sim)./(0.5*sim.L*sim.U^2) # thurst is oposite to background flow
	end
...
manifest_format = "2.0"
project_hash = "592b5f944bf595d878ec9763df173716a2234075"
...
[[deps.WaterLily]]
deps = ["DocStringExtensions", "EllipsisNotation", "ForwardDiff", "KernelAbstractions", "LinearAlgebra", "Printf", "Reexport", "Requires", "StaticArrays", "TOML"]
git-tree-sha1 = "f807036d4e1e111e6a16a0b84417db50c6b99c4c"
