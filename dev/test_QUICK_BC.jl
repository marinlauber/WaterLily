...
println(WaterLily.ϕuL(1,CartesianIndex(2),[0.,0.5,2.],1))
println(WaterLily.ϕ(1,CartesianIndex(2),[0.,0.5,2.0])); println()
# inlet negative flux, backward QUICK
println(WaterLily.ϕuL(1,CartesianIndex(2),[0.,0.5,2.],-1))
println(-WaterLily.quick(2.0,0.5,0.0)); println()

# outlet, positive flux, QUICK
println(WaterLily.ϕuR(1,CartesianIndex(3),[0.,0.5,2.],1))
println(WaterLily.quick(0.,.5,2.)); println()
# outlet, negative flux, CD
println(WaterLily.ϕuR(1,CartesianIndex(3),[0.,0.5,2.],-1))
println(-WaterLily.ϕ(1,CartesianIndex(3),[0.,0.5,2.0]))
